    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, to=settings.get("PUSH_NOTIFICATIONS_SETTINGS", {}).get("USER_MODEL", setting.AUTH_USER_MODEL), null=True, on_delete=models.CASCADE)),
            ],
            options={
